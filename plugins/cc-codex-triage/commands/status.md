---
description: One-screen status of cc-codex-triage in this repo — branch, working tree, shared state path, armed gates and cycle state, thread verdicts, and Codex CLI version. Read-only.
allowed-tools: Bash
