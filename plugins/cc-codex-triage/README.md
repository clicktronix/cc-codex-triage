...
- `/status` — one-screen, read-only view: branch, working tree, shared state path, armed gates with their **cycle state**, last verdict per thread, and the Codex CLI version.
